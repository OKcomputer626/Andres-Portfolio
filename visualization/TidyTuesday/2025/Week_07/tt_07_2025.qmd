...
p <- california %>%
  ...
  ggplot() +
  geom_polygon(aes(x = long, y = lat, group = group, fill = n), color = "gray40") +
...
p1 <- ggdraw(p) +
  ...
  annotate("curve", x = 0.45, y = 0.14, xend = 0.57, yend = 0.2, color = "white", curvature = -0.2, linewidth = 0.7, arrow = arrow(length = unit(0.4, 'cm'))) +
...
The complete code for this analysis is available in [`tt_07_2025.qmd`](https://github.com/OKcomputer626/Andres-Portfolio/blob/master/visualization/TidyTuesday/2024/tt_07_2025.qmd).
